...
photo_url = 'https://www.meme-arsenal.com/memes/d3aa19982f714ab062ae6f020bc818d7.jpg'
token = '6840952011:AAH3AgktK5DOYYwt_iDfh3mgmemsCHikY_o'
...
def main_menu(message):
    if message.text == 'Отправить картинку':
        bot.send_photo(message.chat.id, photo=photo_url, caption='Это вольво сукаВ!')
